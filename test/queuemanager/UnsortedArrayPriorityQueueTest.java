...
public class UnsortedArrayPriorityQueueTest extends PriorityQueueTest{
    ...
    public void wbTestAddHighestSecond() throws Exception 
    {
        ...
        priority = 105;        
        q.add(person, priority);
        String expResult = "[(Richard, 38), (James, 105)]";
        String result = q.toString();
        assertEquals(expResult, result);
    }
    ...
    public void wbTestAddMixedOrder() throws Exception 
    {
        ...
        priority = 25; 
        q.add(person, priority);
        String expResult = "[(Richard, 38), (James, 105), (Gemma, 49), (Natahsa, 106), (Ann, 25)]";
        String result = q.toString();
        assertEquals(expResult, result);
    }
    ...
    public void wbRemoveFromQueueOfFive() throws Exception 
    {
        ...
        q.add(person, priority);
        q.remove();
        String expResult = "[(Richard, 38), (James, 105), (Gemma, 49), (Ann, 25)]";
        String result = q.toString();
        assertEquals(expResult, result);
    }
